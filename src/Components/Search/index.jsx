...
export default function Search({search,setsearch,handlesearch}){
    ...
    return <div  className="Search-container  bg-transparent backdrop-blur-[7px] border-white border-2 z-50 w-[400px] m-0 p-0 flex items-center flex-col justify-center gap-10">
